...
import jobs_api
import users_api
from maps.search import get_image_url
...
def show_user(user_id):
    # в условии не было сказано, нужна ли авторизация для просмотра этой страницы,
    # поэтому я решил не добавлять @login_required
    user = users_api.get_user_by_id(user_id).json["user"]
    image_url = get_image_url(user["city_from"], "/static/img/no_photo.jpg")
    params = {
        "title": "Nostalgy",
        "user": user,
        "image_url": image_url,
